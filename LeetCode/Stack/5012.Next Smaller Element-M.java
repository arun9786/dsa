...
5012.Next Smaller Element

Next Smaller Element
Difficulty: MediumAccuracy: 36.26%Submissions: 220K+Points: 4Average Time: 20m
...
Space Complexity: O(N) for the stack and O(N) for the answer list, resulting in O(N) overall.
